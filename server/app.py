...
sample_hackathons = [
    ...
    },
    {
        ...
        "prize_amount": 15000, "location": "San Francisco, CA",
...
@app.route("/")
def home():
    return jsonify({"message": "Hackathon Scraper API is running!", "status": "healthy"})
...
if __name__ == "__main__":
    PORT = int(os.getenv("PORT", 5001))  # Railway uses dynamic port
